<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-16">
            ...
            <!-- Barre de recherche -->
            <form action="{{ route('search') }}" method="GET" class="flex items-center mr-6">
                <input type="text" name="query" placeholder="Rechercher des posts ou utilisateurs"
                       class="border border-gray-300 rounded-lg px-4 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500" required>
